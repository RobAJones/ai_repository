#include "time.h"
/*
 * ESP32-S3 AI CAM - OpenAI Interface v2.0.26
 * 
 * EPS32S3 DEV Module
 * Tools Tab in IDE
 ...
 * - Automatic analysis package saving to /analysis/[timestamp]/ with:
 *   prompt.txt, response.txt, combined.txt, metadata.txt, audio.mp3
 */
...
void setup() {
  ...
  delay(1000);
  Serial.println("\n\n========================================");
  Serial.println("ESP32-S3 - OpenAI Interface v2.0.26");
  Serial.println("========================================\n");
  ...
  Serial.println("\n========================================");
  Serial.println("SYSTEM READY - Interface v2.0.26");
