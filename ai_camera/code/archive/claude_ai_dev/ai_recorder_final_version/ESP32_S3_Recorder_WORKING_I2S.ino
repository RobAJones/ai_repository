/*
 * ESP32-S3 AI CAM - Camera & Audio Recorder (WORKING!)
 * 
 * FIXED: Microphone is Standard I2S (not PDM)
 * Using correct configuration based on testing
 */
...
// I2S Microphone pins (STANDARD I2S, not PDM!)
#define I2S_SCK_PIN       38  // Bit Clock
#define I2S_WS_PIN        38  // Word Select (same as SCK for this mic)
#define I2S_SD_PIN        39  // Serial Data

// Audio configuration for standard I2S
#define SAMPLE_RATE       44100  // Standard audio rate
...
void initI2S() {
  Serial.println("Initializing I2S for standard I2S microphone...");
  
  i2s_driver_uninstall(I2S_PORT);
  
  // Standard I2S configuration (NOT PDM!)
  ...
  Serial.println("✓ I2S microphone initialized at 44.1kHz");
}
