 ...
 * 
 * Uses ESP_I2S library (blocking recordWAV) with clear UI feedback
 * Note: Recording happens AFTER clicking stop (shows duration countdown)
 */
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info">
                ℹ️ <strong>How recording works:</strong> Click Record to start timer. 
                Click Stop when done - device will then capture that duration of audio. 
                Please wait during processing (a few seconds).
            </div>
    ...
    <script>
        ...
        function stopRecording() {
            ...
            showStatus('⏳ Now recording ' + duration + ' seconds of audio...');
            ...
            fetch('/audio/stop')
                ...
                .then(d => {
                    ...
                    if (d.success) {
                        const sizeMB = (d.bytes / 1024 / 1024).toFixed(2);
                        showStatus('✓ Saved! ' + sizeMB + 'MB');
                        loadAudioFiles();
                    } else {
