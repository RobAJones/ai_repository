...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="gallery">
                <h2>[FILES] Saved Images (<span id="imageCount">0</span>)</h2>
        ...
        function refreshGallery() {
            ...
            fetch('/list')
                ...
                .catch(error => {
                    ...
                    showStatus('[ERROR] Gallery error: ' + error, true);
                });
        }
...
void setup() {
  ...
  // Initialize SD card (1-bit mode) with custom pins
  // DFRobot ESP32-S3 AI CAM uses: CMD=11, CLK=12, D0=13
  ...
  if (!SD_MMC.begin("/sdcard", true)) {  // true = 1-bit mode
    ...
    Serial.println("  - Pins: CMD=11, CLK=12, D0=13");
  } else {
